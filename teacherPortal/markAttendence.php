		  ...
		  <div class="col-4 form-group">
                  <label>Date:</label>
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" name="select_date" class="form-control datetimepicker-input select_date" data-target="#reservationdate"/ required>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Mark Student Attendance</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
			  <div id="error-msg"></div>
                <table id="example1" class="table table-bordered table-striped  make-hidden">
                  <thead>
                  <tr>
                    <th>Student ID</th>
					<th>Name</th>
