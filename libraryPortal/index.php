              ...
              <div class="card-body">
				...
				?>
							...
							<p>Number Of Books</p>
							  ...
							  <a href="bookList.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
							</div>
						  </div>
						  <!-- ./col -->
						  <div class="col-lg-3 col-6">
						...
						?>
								...
								<p>Number of Books out</p>
							  </div>
							  <div class="icon">
								<i class="ion ion-stats-bars"></i>
							  </div>
							  <a href="lendBookList.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
							</div>
						  </div>
						  <!-- ./col -->
						  <div class="col-lg-3 col-6">
						...
						?>
						  ...
						  <div class="col-lg-3 col-6">
							...
							<div class="small-box bg-danger">
							  <div class="inner">
							  <?php 
						$query = "SELECT * FROM notice where department='lib'";
						$result_end = mysqli_query($conn, $query);
						$num_end = mysqli_num_rows($result_end);
						?>
								<h3><?php echo $num_end ; ?></h3>

								<p>Notices are published</p>
							  </div>
							  <div class="icon">
								<i class="ion ion-pie-graph"></i>
							  </div>
							  <a href="allNotices.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
							</div>
						  </div>
						  <!-- ./col -->
						</div>
